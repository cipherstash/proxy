...
| `cipherstash_proxy_statements_session_duration_seconds`       | Histogram | TODO Duration of time CipherStash Proxy spent executing SQL statements           |
| `cipherstash_proxy_statements_session_duration_seconds_count` | Count     | TODO Number of observations of CipherStash Proxy statement duration              |
| `cipherstash_proxy_statements_session_duration_seconds_sum`   | Count     | TODO Total time CipherStash Proxy spent executing SQL statements                 |
